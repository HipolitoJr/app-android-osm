package com.example.hipolito.app_android_osm.utils
...
class SecurityPreferences(context: Context) {
    ...
    private val sharedPreferences: SharedPreferences = context.getSharedPreferences("refeitorio", Context.MODE_PRIVATE)
